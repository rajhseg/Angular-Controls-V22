import { AfterViewInit, ChangeDetectorRef, Component, ElementRef, HostBinding, input, Input, OnChanges, SimpleChanges, ViewChild, ChangeDetectionStrategy } from '@angular/core';
