import { AfterContentChecked, AfterContentInit, AfterViewInit, ApplicationRef, ChangeDetectionStrategy, ChangeDetectorRef, Compiler, Component, ComponentRef, ContentChildren, Directive, ElementRef, EventEmitter, Host, HostBinding, inject, Injector, Input, ModuleWithProviders, NgModule, NgModuleRef, Output, QueryList, Renderer2, RendererFactory2, Self, TemplateRef, Type, ViewChild, ViewChildren, ViewContainerRef, ViewEncapsulation } from "@angular/core";
import { RTabComponent, RTabIdFor, RTabHeaderWithTabId } from "../rtab/rtab.component";
import { AsyncPipe, CommonModule, JsonPipe, NgClass, NgTemplateOutlet, NgStyle } from "@angular/common";
