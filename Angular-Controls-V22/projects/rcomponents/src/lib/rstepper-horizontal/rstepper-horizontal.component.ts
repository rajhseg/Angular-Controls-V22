import { AfterContentInit, ChangeDetectorRef, Component, ContentChildren, EventEmitter, HostBinding, Input, Output, QueryList, ViewChild, ViewContainerRef, ChangeDetectionStrategy, ElementRef } from '@angular/core';
