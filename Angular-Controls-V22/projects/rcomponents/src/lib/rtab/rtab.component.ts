import { AfterContentInit, AfterViewInit, ChangeDetectorRef, Component, ContentChild, ContentChildren, Directive, ElementRef, EventEmitter, forwardRef, Host, inject, Input, Output, output, QueryList, TemplateRef, ViewContainerRef, ChangeDetectionStrategy } from '@angular/core';
