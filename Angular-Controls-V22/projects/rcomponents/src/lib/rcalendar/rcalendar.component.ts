import { AfterViewInit, ChangeDetectorRef, Component, ElementRef, EventEmitter, HostBinding, Inject, Injector, Input, OnDestroy, OnInit, Output, ViewChild, afterNextRender, forwardRef, inject, output, ChangeDetectionStrategy } from '@angular/core';
import { Day, Month, Week } from './rcalendarModels';
import { NgClass, CommonModule, NgStyle, DatePipe } from '@angular/common';
...
@Component({
    selector: 'rcalendar',
    imports: [NgClass, NgStyle, FormsModule, RTextboxComponent, ReactiveFormsModule, RDropdownComponent],
