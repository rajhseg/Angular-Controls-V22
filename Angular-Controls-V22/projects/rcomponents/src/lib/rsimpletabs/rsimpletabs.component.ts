...
import { AfterContentChecked, AfterContentInit, AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChildren, ElementRef, EventEmitter, Host, HostBinding, Input, Output, QueryList, RendererFactory2, TemplateRef, ViewContainerRef, ViewEncapsulation } from "@angular/core";
...
@Component({
    ...
    imports: [NgTemplateOutlet, RTabComponent, RTabIdFor, AsyncPipe, NgStyle, TitleCasePipe, NgClass, JsonPipe, NgStyle],
